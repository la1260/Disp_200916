...
//			String.format("%ty-%1$tm-%1$td %1$tH:%1$tM:%1$tS", nextms)+"\t"
	...
	public Main() {
		...
		rail.put(0, Rail.Type.J, 0, 6, 8, 9, null, 72/3.6, 36/3.6, 18, 4, 0, 0);
		rail.put(1, Rail.Type.J, 0, 7, 11, 10, null, 72/3.6, 36/3.6, 18, 6, 0, 0);
		rail.put(2, Rail.Type.J, 0, 8, 12, 10, null, 72/3.6, 36/3.6, 20, 4, 0, 0);
		rail.put(3, Rail.Type.J, 0, 11, 13, 9, 14, 72/3.6, 36/3.6, 20, 6, 0, 0);
		rail.put(4, Rail.Type.J, 0, 15, 16, null, null, 72/3.6, null, 36, 9, 0, 0);
		rail.put(5, Rail.Type.J, 0, 16, 17, null, null, 72/3.6, null, 36, 11, 0, 0);
		rail.put(6, Rail.Type.L, 25, 18, 0, null, null, null, null, 16, 4, 2, 0);
		rail.put(7, Rail.Type.L, 25, 19, 1, null, null, null, null, 16, 6, 2, 0);
		rail.put(8, Rail.Type.L, 25, 0, 2, null, null, null, null, 18, 4, 2, 0);
		rail.put(9, Rail.Type.L, 25, 0, 3, 10, null, null, null, 18, 4, 2, 2);
		rail.put(10, Rail.Type.L, 25, 1, 2, 9, null, null, null, 18, 6, 2, -2);
		rail.put(11, Rail.Type.L, 25, 1, 3, null, null, null, null, 18, 6, 2, 0);
		rail.put(12, Rail.Type.L, 25, 2, 20, null, null, null, null, 20, 4, 2, 0);
		rail.put(13, Rail.Type.L, 25, 3, 21, null, null, null, null, 20, 6, 2, 0);
		rail.put(14, Rail.Type.L, 25, 3, 24, null, null, null, null, 20, 6, 2, 2);
		rail.put(15, Rail.Type.L, 25, 24, 4, null, null, null, null, 34, 8, 2, 2);
		rail.put(16, Rail.Type.L, 25, 4, 5, null, null, null, null, 36, 10, 0, 2);
		rail.put(17, Rail.Type.L, 25, 5, 25, null, null, null, null, 34, 14, 2, -2);
		rail.put(18, Rail.Type.R, 500, 27, 6, null, null, 90/3.6, null, 4, 4, 12, 0);
		rail.put(19, Rail.Type.R, 500, 28, 7, null, null, 90/3.6, null, 4, 6, 12, 0);
		rail.put(20, Rail.Type.R, 500, 12, 22, null, null, 90/3.6, null, 22, 4, 12, 0);
		rail.put(21, Rail.Type.R, 500, 13, 23, null, null, 90/3.6, null, 22, 6, 12, 0);
		rail.put(22, Rail.Type.R, 500, 20, 29, null, null, 90/3.6, null, 34, 4, 12, 0);
		rail.put(23, Rail.Type.R, 500, 21, 30, null, null, 90/3.6, null, 34, 6, 12, 0);
		rail.put(24, Rail.Type.R, 500, 14, 15, null, null, 80/3.6, null, 22, 8, 12, 0);
		rail.put(25, Rail.Type.R, 500, 17, 26, null, null, 90/3.6, null, 22, 14, 12, 0);
		rail.put(26, Rail.Type.R, 500, 25, 31, null, null, 90/3.6, null, 10, 14, 12, 0);
		rail.put(27, Rail.Type.T, 0, 18, null, null, null, null, null, 4, 4, 0, 0);
		rail.put(28, Rail.Type.T, 0, 19, null, null, null, null, null, 4, 6, 0, 0);
		rail.put(29, Rail.Type.T, 0, 22, null, null, null, null, null, 46, 4, 0, 0);
		rail.put(30, Rail.Type.T, 0, 23, null, null, null, null, null, 46, 6, 0, 0);
		rail.put(31, Rail.Type.T, 0, 26, null, null, null, null, null, 10, 14, 0, 0);
